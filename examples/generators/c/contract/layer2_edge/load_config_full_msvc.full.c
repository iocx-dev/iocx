...
int main(void) {
    ...
    lc.SecurityCookie = 0x14003000ULL; /* in .rdata */
    lc.SEHandlerTable = 0x14003080ULL; /* in .rdata */
    lc.SEHandlerCount = 1;
    lc.GuardCFCheckFunctionPointer = 0x14001000ULL; /* in .text */
    lc.GuardCFDispatchFunctionPointer = 0x14001010ULL;
    lc.GuardCFFunctionTable = 0x140030A0ULL; /* in .rdata */
    ...
    /* SEH table: one entry */
    uint64_t seh_entry = 0x14001020ULL;
    w(f, &seh_entry, sizeof(seh_entry));

    /* Guard CF function table: one entry */
    uint64_t cf_entry = 0x14001030ULL;
