...
class ReasonCodes:
    ...
    # ----------------------------------------------------------------------
    # v0.7.6 — Debug directory (IMAGE_DEBUG_DIRECTORY)
    # ----------------------------------------------------------------------
